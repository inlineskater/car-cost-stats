    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          <div className="bg-blue-500 rounded-2xl p-3 mb-3">
            <Car size={32} className="text-white" />
          </div>
          <h1 className="text-2xl font-bold text-white">Car Cost Tracker</h1>
          <p className="text-slate-400 text-sm mt-1">Track every kilometre and every cent</p>
        </div>
